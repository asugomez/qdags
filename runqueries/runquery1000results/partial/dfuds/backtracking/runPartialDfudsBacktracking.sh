...
for type_fun in 0; do
  chmod a+x *.sh
  data_csv="../../../../outputs/query1000results/partial/dfuds/backtracking/results-f$type_fun-v1000-nodes.csv"
  # echo type fun
  ...
  for k in 1 10 100 1000; do
    ...
    for file in j3 j4 p2 p3 p4 s1 s2 s3 s4 t2 t3 t4 ti2 ti3 ti4 tr1 tr2; do
      ...
      results_file="../../../../outputs/query1000results/partial/dfuds/backtracking/$file-f$type_fun-k$k-v1000-nodes.txt"
