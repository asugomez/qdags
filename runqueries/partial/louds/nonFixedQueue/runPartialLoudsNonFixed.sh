...
#  echo >> ../../../outputs/partial/louds/nonFixedQueue/results.csv
  printf $size_queue, >> ../../../outputs/partial/louds/nonFixedQueue/results.csv
  for file in j3 j4 p2 p3 p4 s1 s2 s3 s4 t2 t3 t4 ti2 ti3 ti4 tr1 tr2; do
    ...
    results_file="../../../outputs/partial/louds/nonFixedQueue/$file.txt"
    ...
    printf $mean, >> ../../../outputs/partial/louds/nonFixedQueue/results.csv
  done
  echo "" >> ../../../outputs/partial/louds/nonFixedQueue/results.csv
