...
//    att_R.push_back(AT_X2); att_R.push_back(AT_X1);
//    att_S.push_back(AT_X3); att_S.push_back(AT_X2);
...
//	quadtree_formula* join_r_s_t_pred = compute_pred_lqdag_join(Q, k, res, &pred1);
