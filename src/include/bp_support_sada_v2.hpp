...
*/
/*! \file bp_support_sada_v2_v2.hpp
    \brief bp_support_sada_v2.hpp contains an implementation of a balanced
     parentheses support structure proposed by Kunihiko Sadakane.
     This version has public fwd and bwd excess functions.
     edited by Asuncion Gomez
*/
#ifndef INCLUDED_SDSL_BP_SUPPORT_SADA_V2
#define INCLUDED_SDSL_BP_SUPPORT_SADA_V2
 ...
 */
    ...
    private:
        static_assert(0 < t_sml_blk, "bp_support_sada_v2: t_sml_blk should be greater than 0!");
...
//#define USE_CACHE
        ...
        void copy(const bp_support_sada_v2& bp_support)
        {
    ...
    public:
        ...
        //! Constructor
        explicit bp_support_sada_v2(const bit_vector* bp): m_bp(bp),
        ...
        //! Move constructor
        bp_support_sada_v2(bp_support_sada_v2&& bp_support)
        {
            *this = std::move(bp_support);
        }

        //! Assignment operator
        bp_support_sada_v2& operator=(bp_support_sada_v2&& bp_support)
        {
            if (this != &bp_support) {
         ...
         */
        void swap(bp_support_sada_v2& bp_support)
        {
        ...
        //! Assignment operator
        bp_support_sada_v2& operator=(const bp_support_sada_v2& bp_support)
        {
            if (this != &bp_support) {
                copy(bp_support);
            }
        ...
        /*
                bp_support_sada_v2& operator=(bp_support_sada_v2&& bps)
                {
                    this->swap(bps);
                    return *this;
                }
        */
        ...
        size_type find_open(size_type i)const
        {
            ...
            if (find_open_cache.exists(i, a)) {
                ...
                size_type_k2 bwd_ex = bwd_excess(i,0);
                if (bwd_ex == size())
                    a = size();
                else
                    a = bwd_ex+1;
        ...
        size_type rmq(size_type l, size_type r)const
        {
            ...
            if (sbl == sbr) { // if l and r are in the same small block
                ...
                for (size_type_k2 v=mbl+1+m_med_inner_blocks; v < mbr + m_med_inner_blocks; ++v) {
                    assert(is_leaf(v));
        ...
        */
        ...
        //! Serializes the bp_support_sada_v2 to a stream.
        /*!
        ...
        //! Load the bp_support_sada_v2 for a bit_vector v.
        /*!
